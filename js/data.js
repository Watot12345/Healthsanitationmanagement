...
<<<<<<< HEAD
    ...
    logs: [
  // Security
  { id: 1, timestamp: '2026-06-22 09:15:32', user: 'Maria Santos', action: 'User role updated for Carlos Lim', module: 'User Management', level: 'info' },
  { id: 2, timestamp: '2026-06-22 08:45:10', user: 'Juan Dela Cruz', action: 'Permit approved #SP-1042', module: 'Sanitation', level: 'success' },
  { id: 3, timestamp: '2026-06-22 08:30:00', user: 'System', action: 'Database backup completed successfully', module: 'System', level: 'success' },
  { id: 4, timestamp: '2026-06-22 07:55:22', user: 'Ana Reyes', action: 'Outbreak alert triggered - Influenza cluster', module: 'Surveillance', level: 'error' },
  { id: 5, timestamp: '2026-06-22 07:00:00', user: 'System', action: 'Vaccine stock critical: MMR - 15 doses remaining', module: 'Immunization', level: 'warning' },
  { id: 6, timestamp: '2026-06-22 06:30:00', user: 'Maria Santos', action: 'Viewed patient P-102 medical history', module: 'Patient Records', level: 'info' },
  { id: 7, timestamp: '2026-06-22 06:00:00', user: 'System', action: 'User Maria Santos logged in from 192.168.1.100', module: 'Authentication', level: 'info' },
  { id: 8, timestamp: '2026-06-21 23:00:00', user: 'System', action: 'Unauthorized access attempt blocked from IP 10.0.0.55', module: 'Security', level: 'error' },
  { id: 9, timestamp: '2026-06-21 16:20:45', user: 'Pedro Garcia', action: 'Appointment booked - General Checkup', module: 'Health Center', level: 'info' },
  { id: 10, timestamp: '2026-06-21 15:00:00', user: 'Maria Santos', action: 'Monthly surveillance report generated', module: 'Reports', level: 'info' },
  { id: 11, timestamp: '2026-06-21 14:30:00', user: 'Juan Dela Cruz', action: 'Inspection failed: ABC Restaurant - Sanitation violation', module: 'Sanitation', level: 'error' },
  { id: 12, timestamp: '2026-06-21 14:10:00', user: 'System', action: 'Multiple failed login attempts for user Rosa Mendoza', module: 'Security', level: 'warning' },
  { id: 13, timestamp: '2026-06-21 11:00:00', user: 'Ana Reyes', action: 'Patient record P-103 updated - New diagnosis', module: 'Patient Records', level: 'info' },
  { id: 14, timestamp: '2026-06-21 09:00:00', user: 'Admin', action: 'System settings modified - Email notifications enabled', module: 'Settings', level: 'warning' },
  { id: 15, timestamp: '2026-06-20 15:00:00', user: 'Maria Santos', action: 'Bulk export: Patient records (243 entries)', module: 'Data Export', level: 'info' },
  { id: 16, timestamp: '2026-06-20 10:00:00', user: 'System', action: 'Automatic log archive created (Q1 2026)', module: 'System', level: 'info' },
],
    appointments: [
