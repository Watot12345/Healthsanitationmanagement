            ...
            <div class="overlay">
                ...
                <div class="overlay-panel overlay-left">
                    <div class="absolute top-10 left-12 flex items-center space-x-8 text-sm font-bold tracking-wider">
                        ...
                        <a href="#" class="text-blue-50 hover:text-white hover:underline transition-all">ABOUT</a>
                        <a href="#" class="text-blue-50 hover:text-white hover:underline transition-all">CONTACT</a>
                        <a href="#" class="text-blue-50 hover:text-white hover:underline transition-all">DOWNLOAD</a>
                    </div>
